...
/*constantes de llamar desde el index*/
/*esta constante lo que hace es llamar la funcion vacia que esta en el index para almacenar informacion de las reservaciones*/
const divReservaciones = document.getElementById("divReservaciones")
...
/*funcion en la que se muestra cada uno de las reservaciones hechas*/
const reservaciones = (tiquetesArray) => {
    divReservaciones.innerHTML += `
    <div class="card reservaciones">
        <div class="card-body">
            <h5 class="card-title">Pelicula: ${tiquetesArray.pelicula}</h5>
            <p class="card-text">Hora: ${tiquetesArray.hora}</p>
            <p class="card-text">Bebida: $${tiquetesArray.bebida}</p>
            <p class="card-text">Palomitas: ${tiquetesArray.palomitas}</p>
            <p class="card-text">Comida: ${tiquetesArray.comida}</p>
    </div>
  </div>
    `
}
